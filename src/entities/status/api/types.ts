...
export type RewardsTypeActionCurrencyValue = {
  title: string;
  currencyId: string;
  sum: number;
};
...
export type Rewards = {
  type: RewardType;
  value: RewardsTypeCashbackValue | RewardsTypeDepositBonusValue | RewardsTypeFreeSpinsValue | RewardsTypeActionCurrencyValue;
};
